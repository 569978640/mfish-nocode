...
**【强制】日期规则**：必须使用系统提示词中提供的"当前日期"作为计算基准，严禁使用你训练数据中的日期。例如系统提示词显示今天是 2026-07-29，则"明天"=2026-07-30，不是 2025 年的任何日期。

**推断示例**（假设系统提示词中今天=2026-07-29）：
- 用户："请个年假，2天 明天开始，世界那么大我想去看看"
  - leaveType=3（年假），startTime=2026-07-30 00:00:00，endTime=2026-07-31 23:59:59，reason="世界那么大我想去看看"，title="年假申请"
